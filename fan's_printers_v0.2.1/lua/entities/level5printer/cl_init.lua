...
function ENT:Draw()
	...
	local rateui = faniredprintamount * 12
...
Ang:RotateAroundAxis(Ang:Up(), 90)
	...
	draw.RoundedBox(7, -340, -254, 680, 500, Color(164,0,0))
	...
	draw.SimpleText(ptype ..faniredname, "PrinterFont", 0, -207,  Color( 255, 255, 255, 255 ), 1, 1)
