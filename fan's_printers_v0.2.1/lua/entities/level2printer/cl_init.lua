...
function ENT:Draw()
	...
	local rateui = faniblueprintamount * 12
...
Ang:RotateAroundAxis(Ang:Up(), 90)
	...
	draw.RoundedBox(7, -340, -254, 680, 500, Color(0,0,104))
    ...
    draw.SimpleText(ptype ..fanibluename, "PrinterFont", 0, -207,  Color( 255, 255, 255, 255 ), 1, 1)
