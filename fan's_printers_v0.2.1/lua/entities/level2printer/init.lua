...
ENT.SeizeReward = faniblueprintamount

local PrintMore
function ENT:Initialize()
	local scolor = fanibluecolor
	...
	timer.Simple(faniblueprinttime, function() PrintMore(self) end)
...
function ENT:CreateMoneybag()
	...
	local amount = faniblueprintamount
