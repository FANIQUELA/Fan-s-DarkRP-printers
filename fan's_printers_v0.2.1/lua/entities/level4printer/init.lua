...
ENT.SeizeReward = faniorangeprintamount

local PrintMore
function ENT:Initialize()
	local scolor = faniorangecolor
	...
	timer.Simple(faniorangeprinttime, function() PrintMore(self) end)
...
function ENT:CreateMoneybag()
	...
	local amount = faniorangeprintamount
