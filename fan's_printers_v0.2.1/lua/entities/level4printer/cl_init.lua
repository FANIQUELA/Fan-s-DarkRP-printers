...
function ENT:Draw()
	...
	local rateui = faniorangeprintamount * 12
	...
	draw.RoundedBox(7, -340, -254, 680, 500, Color(184,82,0))
	...
	draw.SimpleText(ptype ..faniorangename, "PrinterFont", 0, -207,  Color( 255, 255, 255, 255 ), 1, 1)
