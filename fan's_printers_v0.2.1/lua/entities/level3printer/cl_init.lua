...
function ENT:Draw()
	...
	local rateui = faniyellowprintamount * 12

  	local ptype = faniptypeselector
	...
	draw.RoundedBox(7, -340, -254, 680, 500, Color(170,170,0))
	...
	draw.SimpleText(ptype ..faniyellowname, "PrinterFont", 0, -207,  Color( 255, 255, 255, 255 ), 1, 1)
