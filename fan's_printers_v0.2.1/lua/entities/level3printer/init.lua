...
ENT.SeizeReward = faniyellowprintamount

local PrintMore
function ENT:Initialize()
	local scolor = faniyellowcolor
	...
	timer.Simple(faniyellowprinttime, function() PrintMore(self) end)
...
function ENT:CreateMoneybag()
	...
	local amount = faniyellowprintamount
