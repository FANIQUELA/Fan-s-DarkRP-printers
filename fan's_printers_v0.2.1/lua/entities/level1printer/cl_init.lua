...
function ENT:Draw()
	...
	local rateui = fanigreenprintamount * 12
	...
	draw.RoundedBox(7, -340, -254, 680, 500, Color(20,120,60))
	...
	draw.SimpleText(ptype ..fanigreenname, "PrinterFont", 0, -207,  Color( 255, 255, 255, 255 ), 1, 1)
